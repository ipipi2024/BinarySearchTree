...
3. Check if root.size == 1 or root.key == key
        ...
        3.3.1. if true
            3.3.1.1 check if parent.leftchild == null
                ...
                3.3.1.1.2 if false , check if key == parent.leftchild.key
                    3.3.1.1.2.1 if true then key is found so return parent node
        ...
        3.3.2 if false
            3.3.2.1 check if parent.rightchild == null
                ...
                3.3.2.1.2 if false, check if key == parent.rightchild.key
                    3.3.2.1.2.1 if true then key is found so return parent node
